...
var _toJson = __webpack_require__(29);
...
function ajaxContact(e) {
  ...
  */
  ...
  var json = (0, _toJson2.default)(this);
  //console.log(json);
  _axios2.default.post(this.action, json).then(function (res) {
    console.log(res);
  }).catch(console.error);
}

exports.default = ajaxContact;
...
var contactForms = (0, _bling.$$)('form.contact');
contactForms.on('submit', _contact2.default);
